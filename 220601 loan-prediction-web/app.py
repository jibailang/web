...
def submit():
    if request.method == 'POST':
        ...
        #Credit_History #Line.16~72 keep user input
        Credit_History_Yes = ''
        Credit_History_No = ''
        ...
        result = model_pretrained.predict([[int(form_data['Credit_History']),int(form_data['Gender']),int(form_data['Married']),int(form_data['Education']),int(form_data['Dependents']),int(form_data['Self_Employed']),int(form_data['Property_Area']),int(np.log(int(form_data['LoanAmount']))),int(np.log(int(form_data['TotalIncome'])))]])
        result_proba = model_pretrained.predict_proba([[int(form_data['Credit_History']),int(form_data['Gender']),int(form_data['Married']),int(form_data['Education']),int(form_data['Dependents']),int(form_data['Self_Employed']),int(form_data['Property_Area']),int(np.log(int(form_data['LoanAmount']))),int(np.log(int(form_data['TotalIncome'])))]])
